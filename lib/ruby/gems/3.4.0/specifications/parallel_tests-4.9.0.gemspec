# -*- encoding: utf-8 -*-
# stub: parallel_tests 4.9.0 ruby lib

Gem::Specification.new do |s|
  s.name = "parallel_tests".freeze
  s.version = "4.9.0".freeze

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "bug_tracker_uri" => "https://github.com/grosser/parallel_tests/issues", "changelog_uri" => "https://github.com/grosser/parallel_tests/blob/v4.9.0/CHANGELOG.md", "documentation_uri" => "https://github.com/grosser/parallel_tests/blob/v4.9.0/Readme.md", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/grosser/parallel_tests/tree/v4.9.0", "wiki_uri" => "https://github.com/grosser/parallel_tests/wiki" } if s.respond_to? :metadata=
